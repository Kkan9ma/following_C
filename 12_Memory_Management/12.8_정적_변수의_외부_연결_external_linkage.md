...
<img src="https://github.com/uber9ma/following_C/blob/master/images/chapter12/scope9.png?raw=true">
...
<img src="https://github.com/uber9ma/following_C/blob/master/images/chapter12/scope10.png?raw=true">

* `fun_sec()`를 main에서 부르기: 선언만 하면 됨.
* `main.c`에 정의되어 있는 변수 쓰기
    - `extern int g_int`

<img src="https://github.com/uber9ma/following_C/blob/master/images/chapter12/scope11.png?raw=true">
